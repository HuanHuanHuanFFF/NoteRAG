...
public enum CodeStatus {
    ...
    LLM_CONFIG_INVALID(50006, "LLM configuration invalid", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    LLM_FAILED(50205, "LLM 服务调用失败", HttpStatus.BAD_GATEWAY),
    LLM_RESULT_INVALID(50206, "LLM 结果异常", HttpStatus.BAD_GATEWAY),
