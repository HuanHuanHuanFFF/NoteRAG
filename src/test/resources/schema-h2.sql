CREATE TABLE notes (
    ...
    CONSTRAINT notes_status_supported CHECK (status IN ('ACTIVE', 'ARCHIVED'))
);

CREATE INDEX idx_notes_status_created_id
...
CREATE TABLE note_chunks (
    ...
    token_count INTEGER NOT NULL,
    created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT note_chunks_chunk_type_supported CHECK (chunk_type IN ('CONTENT', 'SUMMARY')),
    CONSTRAINT fk_note_chunks_note
        FOREIGN KEY (note_id) REFERENCES notes(id) ON DELETE CASCADE,
    CONSTRAINT uk_note_chunks_note_type_chunk_index UNIQUE (note_id, chunk_type, chunk_index)
);
...
CREATE INDEX idx_chat_sessions_status_last_message_at_updated_id
